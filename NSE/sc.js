...
$(document).ready(function () {
    ...
    $('#scHistoryBtn').on('click', function () {
        ...
        $.get("https://api.smallcase.com/smallcases/discover?count=50&offset=1", function (data) {
            if (data) {
                ...
                historyJson = JSONN5.concat(JSONN4).concat(JSONN3).concat(JSONN2).concat(JSONN1);
                if (historyJson) {
    ...
    function makeEachSmallcaseCall(scID) {
        ...
        $.ajax({
            ...
            headers: {
                "x-csrf-token": "aeb3a9fb",
                "x-sc-jwt": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOiI1ZTExYjk1YmM5OGRlNDM0NjY4YjVjMTQiLCJzZXNzaW9uIjoiMWMwYjgyMmIiLCJjc3JmIjoiYWViM2E5ZmIiLCJhY2Nlc3MiOnsicGxhdGZvcm0iOnRydWV9LCJtZXRob2QiOiJicm9rZXIiLCJhcHAiOiJwbGF0Zm9ybSIsImJyb2tlciI6ImtpdGUiLCJpYXQiOjE2MjgxNTI3NjYsImV4cCI6MTYyODc1NzU2Nn0.Ojay0iFqETJlzH5XXDkiVsqmzVKU2xV_h38Q5ZLSrU8"
            },
            dataType: "json",
